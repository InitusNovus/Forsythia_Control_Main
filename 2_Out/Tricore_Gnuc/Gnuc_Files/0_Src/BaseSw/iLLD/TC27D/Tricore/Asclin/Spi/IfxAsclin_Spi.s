...
.LVL97:
	.loc 1 296 0
	movh	%d2, hi:defaultConfig.10065
	mov.a	%a2, %d2
	mov.aa	%a3, %a4
	lea	%a15, [%a2] lo:defaultConfig.10065
...
.section .rodata.defaultConfig.10065,"a",@progbits
	.align 2
	.type	defaultConfig.10065, @object
	.size	defaultConfig.10065, 52
defaultConfig.10065:
	.word	0
	.byte	2
	.zero	1
