# 1 "0_Src/AppSw/Tricore/Main/SchedulerTask_Cpu1.c"
# 1 "C:\\Google drive\\RH_Workspace\\__RH26_Control_Base_TC275//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "0_Src/AppSw/Tricore/Main/SchedulerTask_Cpu1.c"
# 12 "0_Src/AppSw/Tricore/Main/SchedulerTask_Cpu1.c"
...
# 13 "0_Src/AppSw/Tricore/Main/SchedulerTask_Cpu1.c" 2
# 30 "0_Src/AppSw/Tricore/Main/SchedulerTask_Cpu1.c"
...
# 51 "0_Src/AppSw/Tricore/Main/SchedulerTask_Cpu1.c"
void Task_core1_1ms (void)
{
 stm_buf_c1_delay = IfxStm_get(&(*(Ifx_STM*)0xF0000000u));

 waitTime((TimeConst[(4)])*6+(TimeConst[(3)])*3);

 delay_1ms_c1 = (IfxStm_get(&(*(Ifx_STM*)0xF0000000u)) - stm_buf_c1_delay)*1000000/(IfxStm_getFrequency(&(*(Ifx_STM*)0xF0000000u)));
 stm_buf_c1 = IfxStm_get(&(*(Ifx_STM*)0xF0000000u));

 HLD_Imu_run_1ms_c1();

 ticToc_1ms_c1 = (IfxStm_get(&(*(Ifx_STM*)0xF0000000u)) - stm_buf_c1)*1000000/(IfxStm_getFrequency(&(*(Ifx_STM*)0xF0000000u)));
}
