...
# 57 "0_Src/AppSw/Tricore/HLD/BasicModules/Gtm/Tim/GtmTim.c"
 HLD_GtmTim_initChannel(&HLD_GtmTim.ch[0],&IfxGtm_TIM0_2_TIN20_P00_11_IN);
 HLD_GtmTim_initChannel(&HLD_GtmTim.ch[1],&IfxGtm_TIM3_3_TIN13_P00_4_IN);
 HLD_GtmTim_initChannel(&HLD_GtmTim.ch[2],&IfxGtm_TIM0_3_TIN21_P00_12_IN);
 HLD_GtmTim_initChannel(&HLD_GtmTim.ch[3],&IfxGtm_TIM2_4_TIN14_P00_5_IN);
 HLD_GtmTim_initChannel(&HLD_GtmTim.ch[4],&IfxGtm_TIM0_6_TIN24_P33_2_IN);
 HLD_GtmTim_initChannel(&HLD_GtmTim.ch[5],&IfxGtm_TIM0_5_TIN23_P33_1_IN);
 HLD_GtmTim_initChannel(&HLD_GtmTim.ch[6],&IfxGtm_TIM2_6_TIN100_P11_11_IN);
 HLD_GtmTim_initChannel(&HLD_GtmTim.ch[7],&IfxGtm_TIM2_1_TIN95_P11_2_IN);
 HLD_GtmTim_initChannel(&HLD_GtmTim.ch[8],&IfxGtm_TIM2_2_TIN96_P11_3_IN);
 HLD_GtmTim_initChannel(&HLD_GtmTim.ch[9],&IfxGtm_TIM2_3_TIN97_P11_6_IN);
