...
.LVL19:
	...
	st.w	[%SP] 8, %d15
	.loc 1 117 0
	movh	%d15, hi:IfxGtm_TOM0_7_TOUT25_P33_3_OUT
	addi	%d15, %d15, lo:IfxGtm_TOM0_7_TOUT25_P33_3_OUT
	st.w	[%SP] 16, %d15
	.loc 1 118 0
	lea	%a5, [%SP] 40
	movh	%d15, 16480
...
.LBE10:
	.loc 1 126 0
	movh	%d15, hi:IfxGtm_TOM2_1_TOUT95_P11_2_OUT
	addi	%d15, %d15, lo:IfxGtm_TOM2_1_TOUT95_P11_2_OUT
	st.w	[%SP] 36, %d15
	.loc 1 127 0
	lea	%a5, [%SP] 40
.LVL21:
...
.LASF131:
	.string	"DID_EN11"
	.extern	IfxGtm_TOM2_1_TOUT95_P11_2_OUT,STT_OBJECT,20
	.extern	IfxGtm_TOM0_7_TOUT25_P33_3_OUT,STT_OBJECT,20
