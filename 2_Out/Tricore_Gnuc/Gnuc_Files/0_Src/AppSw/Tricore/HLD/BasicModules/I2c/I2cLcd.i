# 1 "0_Src/AppSw/Tricore/HLD/BasicModules/I2c/I2cLcd.c"
# 1 "C:\\Google drive\\RH_Workspace\\__RH26_Control_Base_TC275//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "0_Src/AppSw/Tricore/HLD/BasicModules/I2c/I2cLcd.c"
# 12 "0_Src/AppSw/Tricore/HLD/BasicModules/I2c/I2cLcd.c"
...
# 13 "0_Src/AppSw/Tricore/HLD/BasicModules/I2c/I2cLcd.c" 2
# 1 "0_Src/BaseSw/Service/CpuGeneric/SysSe\\Bsp\\Bsp.h" 1
# 14 "0_Src/AppSw/Tricore/HLD/BasicModules/I2c/I2cLcd.c" 2

# 1 "0_Src/AppSw/Tricore/HLD/BasicModules/I2c/I2c.h" 1
# 20 "0_Src/AppSw/Tricore/HLD/BasicModules/I2c/I2c.h"
# 1 "0_Src/AppSw/Tricore/HLD/BasicModules/I2c/I2c.h" 1
# 21 "0_Src/AppSw/Tricore/HLD/BasicModules/I2c/I2c.h" 2
...
# 52 "0_Src/BaseSw/iLLD/TC27D/Tricore/I2c/Std/IfxI2c.h"
typedef enum
{
...
# 22 "0_Src/AppSw/Tricore/HLD/BasicModules/I2c/I2c.h" 2
# 40 "0_Src/AppSw/Tricore/HLD/BasicModules/I2c/I2c.h"
typedef struct
{
 struct{
     IfxI2c_I2c i2c;
...
# 57 "0_Src/AppSw/Tricore/HLD/BasicModules/I2c/I2c.h"
extern void HLD_I2c_init(HLD_I2c_t *i2c ,uint8 i2cAddress, float32 baudrate);




static inline __attribute__ ((always_inline)) void HLD_I2c_writeData(IfxI2c_I2c_Device *i2cDevice, volatile uint8 *data, Ifx_SizeT size)
{
 while (IfxI2c_I2c_write(i2cDevice, data, size) == IfxI2c_I2c_Status_nak);
}
# 16 "0_Src/AppSw/Tricore/HLD/BasicModules/I2c/I2cLcd.c" 2
# 1 "0_Src/AppSw/Tricore/HLD/BasicModules/I2c/I2cLcd.h" 1
# 44 "0_Src/AppSw/Tricore/HLD/BasicModules/I2c/I2cLcd.h"
extern void HLD_I2cLcd_init(void);

extern void HLD_I2cLcd_clear(void);
extern void HLD_I2cLcd_home(void);
# 17 "0_Src/AppSw/Tricore/HLD/BasicModules/I2c/I2cLcd.c" 2
# 1 "0_Src/AppSw/Tricore/HLD/BasicModules/I2c/I2cLcdMacro.h" 1
# 18 "0_Src/AppSw/Tricore/HLD/BasicModules/I2c/I2cLcd.c" 2
# 39 "0_Src/AppSw/Tricore/HLD/BasicModules/I2c/I2cLcd.c"
typedef struct
{
 HLD_I2c_t I2c;
 uint8 backlight;
...
# 66 "0_Src/AppSw/Tricore/HLD/BasicModules/I2c/I2cLcd.c"
static void HLD_I2cLcd_write4bit(uint8 data);

static void HLD_I2cLcd_write(uint8 data);
static void HLD_I2cLcd_command(uint8 data);
# 79 "0_Src/AppSw/Tricore/HLD/BasicModules/I2c/I2cLcd.c"
void HLD_I2cLcd_init(void)
{
 printf("I2cLcd initialization start\n");

 HLD_I2c_init(&HLD_Lcd.I2c, 0x4E, 100000);

 waitTime(5*(TimeConst[(6)]));

 {
  byteBuffer = 0x00;
  HLD_I2c_writeData(&HLD_Lcd.I2c.driver.i2cDevice, &byteBuffer, 1);
 }
 waitTime(1*(TimeConst[(8)]));
 ...
 HLD_Lcd.displayFunc = 0x00 | 0x08 | 0x00;
 HLD_I2cLcd_command(0x20 | HLD_Lcd.displayFunc);
 waitTime(50*(TimeConst[(3)]));



 HLD_Lcd.displayCon = 0x04 | 0x02 | 0x01 ;
 HLD_I2cLcd_command(0x08 | HLD_Lcd.displayCon);
 waitTime(50*(TimeConst[(3)]));
 ...
 HLD_Lcd.displayMode = 0x02 | 0x00;
 HLD_I2cLcd_command(0x04 | HLD_Lcd.displayMode);
 waitTime(50*(TimeConst[(3)]));
# 139 "0_Src/AppSw/Tricore/HLD/BasicModules/I2c/I2cLcd.c"
 HLD_I2cLcd_write('a');
...
static void HLD_I2cLcd_write(uint8 data)
{
 uint8 highnip = data&0xf0;
 uint8 lownip = (data&0x0f)<<4;
 HLD_I2cLcd_write4bit((highnip)|0b00000001);
 waitTime(50*(TimeConst[(3)]));
 HLD_I2cLcd_write4bit((lownip)|0b00000001);
 waitTime(50*(TimeConst[(3)]));
}
