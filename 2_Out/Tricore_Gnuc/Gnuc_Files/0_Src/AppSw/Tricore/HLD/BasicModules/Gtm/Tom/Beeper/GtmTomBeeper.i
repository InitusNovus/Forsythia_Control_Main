...
# 134 "0_Src/AppSw/Tricore/HLD/HLD.h"
...
static void HLD_GtmTomBeeper_runInternal(void)
{
 ...
 if(g_GtmTomBeeper.on == 1)
 {
  ...
  IfxPort_setPinModeOutput(IfxGtm_TOM0_3_TOUT80_P14_0_OUT.pin.port, IfxGtm_TOM0_3_TOUT80_P14_0_OUT.pin.pinIndex, IfxPort_OutputMode_pushPull, IfxPort_OutputIdx_alt1);
 }
 else
 {

  IfxPort_setPinModeInput(IfxGtm_TOM0_3_TOUT80_P14_0_OUT.pin.port, IfxGtm_TOM0_3_TOUT80_P14_0_OUT.pin.pinIndex, IfxPort_Mode_inputPullDown);
 }
}
...
void HLD_GtmTomBeeper_init(void)
{
 ...
 timerConfig.tom = IfxGtm_TOM0_3_TOUT80_P14_0_OUT.tom;
 timerConfig.timerChannel = IfxGtm_TOM0_3_TOUT80_P14_0_OUT.channel;
 timerConfig.triggerOut = &IfxGtm_TOM0_3_TOUT80_P14_0_OUT;
