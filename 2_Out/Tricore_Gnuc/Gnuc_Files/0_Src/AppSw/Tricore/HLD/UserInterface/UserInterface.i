# 1 "0_Src/AppSw/Tricore/HLD/UserInterface/UserInterface.c"
# 1 "C:\\Google drive\\RH_Workspace\\__RH26_Control_Base_TC275//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "0_Src/AppSw/Tricore/HLD/UserInterface/UserInterface.c"
# 12 "0_Src/AppSw/Tricore/HLD/UserInterface/UserInterface.c"
...
# 13 "0_Src/AppSw/Tricore/HLD/UserInterface/UserInterface.c" 2
# 1 "0_Src/AppSw/Tricore/HLD/UserInterface/UserInterface.h" 1
# 14 "0_Src/AppSw/Tricore/HLD/UserInterface/UserInterface.c" 2

# 1 "0_Src/AppSw/Tricore/HLD/UserInterface/UserInterface_Button.h" 1
# 24 "0_Src/AppSw/Tricore/HLD/UserInterface/UserInterface_Button.h"
...
# 101 "0_Src/AppSw/Tricore/HLD/UserInterface/UserInterface_Button.h"
extern boolean HLD_UserInterface_pollButton(HLD_button_t* button);
extern void HLD_UserInterface_buttonInit(HLD_button_t* button, HLD_buttonConfig_t* config);
extern void HLD_UserInterface_buttonInitConfig(HLD_buttonConfig_t* config);
# 16 "0_Src/AppSw/Tricore/HLD/UserInterface/UserInterface.c" 2
...
# 17 "0_Src/AppSw/Tricore/HLD/UserInterface/UserInterface.c" 2
# 1 "0_Src/AppSw/Tricore/HLD/UserInterface/Lcd/FloatSeperation.h" 1
# 44 "0_Src/AppSw/Tricore/HLD/UserInterface/Lcd/FloatSeperation.h"
void Separate_int_frac (sint32* intPart, uint32* fracPart, float32 num, uint32 roundnum);
# 18 "0_Src/AppSw/Tricore/HLD/UserInterface/UserInterface.c" 2
...
# 20 "0_Src/AppSw/Tricore/HLD/UserInterface/UserInterface.c" 2
# 51 "0_Src/AppSw/Tricore/HLD/UserInterface/UserInterface.c"
typedef enum
{
 intro,
 view,
...
typedef struct
{
 ...
 HLD_UserInterface_page_t view[3];
 HLD_UserInterface_page_t config[20];
}HLD_UserInterface_t;
...
# 140 "0_Src/AppSw/Tricore/HLD/UserInterface/UserInterface.c"
uint32 Test1 = 325;



static void HLD_UserInterface_installButton(HLD_button_t* button, IfxPort_Pin* port, void (*callBack)(void));

static void HLD_UserInterface_buttonUp(void);
static void HLD_UserInterface_buttonDown(void);
static void HLD_UserInterface_buttonLeft(void);
static void HLD_UserInterface_buttonRight(void);
static void HLD_UserInterface_buttonL1(void);
static void HLD_UserInterface_buttonR1(void);

static void HLD_UserInterface_dispValue(HLD_Lcd_line line);
static void HLD_UserInterface_initPage(HLD_UserInterface_page_t* page, HLD_UserInterface_pageMode mode);
static void HLD_UserInterface_viewMode(void);
# 167 "0_Src/AppSw/Tricore/HLD/UserInterface/UserInterface.c"
HLD_UserInterface_uiButtonConfig_t buttonConfig=
{
  .button[0].pin = &IfxPort_P00_9,
  .button[0].callBack = HLD_UserInterface_buttonUp,

  .button[1].pin = &IfxPort_P00_2,
  .button[1].callBack = HLD_UserInterface_buttonDown,

  .button[2].pin = &IfxPort_P00_3,
  .button[2].callBack = HLD_UserInterface_buttonLeft,

  .button[3].pin = &IfxPort_P00_10,
  .button[3].callBack = HLD_UserInterface_buttonRight,

  .button[4].pin = &IfxPort_P00_11,
  .button[4].callBack = HLD_UserInterface_buttonL1,

  .button[5].pin = &IfxPort_P00_4,
  .button[5].callBack = HLD_UserInterface_buttonR1,
};
# 197 "0_Src/AppSw/Tricore/HLD/UserInterface/UserInterface.c"
void HLD_UserInterface_init(void (*callBack_start)(void))
{

 HLD_UserInterface_installButton(&HLD_UserInterface.startButton, &IfxPort_P11_9, callBack_start);
# 219 "0_Src/AppSw/Tricore/HLD/UserInterface/UserInterface.c"
}
...
void HLD_UserInterface_run_10ms(void)
{
 ...
 HLD_UserInterface_pollButton(&HLD_UserInterface.startButton);
# 245 "0_Src/AppSw/Tricore/HLD/UserInterface/UserInterface.c"
}
...
static void HLD_UserInterface_initPage(HLD_UserInterface_page_t* page, HLD_UserInterface_pageMode mode)
{
 ...
 for(index = 0; index<3; index++)
 {
  ...
  page->value[index].name[6] = '\0';
  page->value[index].val = ((void *)0);
  page->value[index].con = 1;
  page->value[index].inc = 1;
  page->value[index].isFloat = 0;
 }
}
# 511 "0_Src/AppSw/Tricore/HLD/UserInterface/UserInterface.c"
static void HLD_UserInterface_buttonUp(void)
{
 if(HLD_UserInterface.mode == config)
 {
...
{
 if(HLD_UserInterface.isSelected)
  HLD_UserInterface.isSelected = 0;
}
static void HLD_UserInterface_buttonRight(void)
{
 if(HLD_UserInterface.isSelected == 0)
  HLD_UserInterface.isSelected = 1;
}
static void HLD_UserInterface_buttonL1(void)
{
 if(HLD_UserInterface.mode == view)
