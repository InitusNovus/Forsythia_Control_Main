# 1 "0_Src/AppSw/Tricore/HLD/UserInterface/Lcd/Lcd.c"
# 1 "C:\\Google drive\\RH_Workspace\\__RH26_Control_Base_TC275//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "0_Src/AppSw/Tricore/HLD/UserInterface/Lcd/Lcd.c"
# 12 "0_Src/AppSw/Tricore/HLD/UserInterface/Lcd/Lcd.c"
...
# 13 "0_Src/AppSw/Tricore/HLD/UserInterface/Lcd/Lcd.c" 2
# 1 "0_Src/AppSw/Tricore/HLD/UserInterface/Lcd/Lcd.h" 1
# 33 "0_Src/AppSw/Tricore/HLD/UserInterface/Lcd/Lcd.h"
typedef enum
{
 LcdLine0 = 0x00,
 LcdLine1 = 0x40,
...
# 55 "0_Src/AppSw/Tricore/HLD/UserInterface/Lcd/Lcd.h"
extern void HLD_Lcd_init(void);

extern void HLD_Lcd_clear(void);

extern void HLD_Lcd_dispLine(HLD_Lcd_line line, char const *fmt, ...);
extern void HLD_Lcd_dispRowCol(HLD_Lcd_line row, uint8 col, char* text);
extern void HLD_Lcd_dispCharRowCol(HLD_Lcd_line row, uint8 col, char text);
# 14 "0_Src/AppSw/Tricore/HLD/UserInterface/Lcd/Lcd.c" 2
# 1 "0_Src/AppSw/Tricore/HLD/UserInterface/Lcd/usr_sprintf.h" 1
# 15 "0_Src/AppSw/Tricore/HLD/UserInterface/Lcd/usr_sprintf.h"
# 1 "c:\\hightec\\toolchains\\tricore\\v4.9.3.0-infineon-1.0\\lib\\gcc\\tricore\\4.9.4\\include\\stdarg.h" 1 3 4
# 98 "c:\\hightec\\toolchains\\tricore\\v4.9.3.0-infineon-1.0\\lib\\gcc\\tricore\\4.9.4\\include\\stdarg.h" 3 4
typedef __gnuc_va_list va_list;
# 16 "0_Src/AppSw/Tricore/HLD/UserInterface/Lcd/usr_sprintf.h" 2

int usr_vsprintf(char *dest, const char *fmt, va_list ap);

int usr_sprintf(char *buf, char const *fmt, ...);
# 15 "0_Src/AppSw/Tricore/HLD/UserInterface/Lcd/Lcd.c" 2
# 36 "0_Src/AppSw/Tricore/HLD/UserInterface/Lcd/Lcd.c"
char textBuffer[20 +1] = {0};




static void HLD_Lcd_initPin(IfxPort_Pin* pin);

static void HLD_Lcd_dispText(char* buffer);
static void HLD_Lcd_write(uint8 character);
static void HLD_Lcd_command(uint8 command);
static void HLD_Lcd_setDramAddress(uint8 address);

static void HLD_Lcd_put4bits(uint8 data);

static void HLD_Lcd_setPin(IfxPort_Pin* pin, boolean data);
static void HLD_Lcd_setPinHigh(IfxPort_Pin* pin);
static void HLD_Lcd_setPinLow(IfxPort_Pin* pin);
static void HLD_Lcd_setData (boolean isUpper, uint8 data4bit);
static void HLD_Lcd_clockPulse(void);
static void HLD_Lcd_setRs(boolean val);
static void HLD_Lcd_setRw(boolean val);
# 65 "0_Src/AppSw/Tricore/HLD/UserInterface/Lcd/Lcd.c"
void HLD_Lcd_init(void)
{
 printf("Lcd_init() called\n");
 HLD_Lcd_initPin(&IfxPort_P15_0);
 HLD_Lcd_initPin(&IfxPort_P20_0);
 HLD_Lcd_initPin(&IfxPort_P33_8);
 HLD_Lcd_initPin(&IfxPort_P33_9);
 HLD_Lcd_initPin(&IfxPort_P15_1);
 HLD_Lcd_initPin(&IfxPort_P33_4);
 HLD_Lcd_initPin(&IfxPort_P33_12);


 {
  HLD_Lcd_setData(1,0b0011);
  HLD_Lcd_clockPulse();
  waitTime(50*(TimeConst[(3)]));
 ...
 usr_sprintf(textBuffer, "HLD_V.%d.%d.%d", 0, 3, 0);
...
static inline __attribute__ ((always_inline)) void HLD_Lcd_initPin(IfxPort_Pin* pin)
{
...
void HLD_Lcd_dispLine(HLD_Lcd_line line, char const *fmt, ...)
{
 char textBuffer[20 +1] = {0};
...
void HLD_Lcd_clear(void)
{
 ...
 waitTime(2*(TimeConst[(5)]));
}

static inline __attribute__ ((always_inline)) void HLD_Lcd_setDramAddress(uint8 address)
{
...
static inline __attribute__ ((always_inline)) void HLD_Lcd_put4bits(uint8 data)
{
 HLD_Lcd_setData(1,data);
 HLD_Lcd_clockPulse();
}
...
static void HLD_Lcd_clockPulse(void)
{
 ...
 HLD_Lcd_setPinHigh(&IfxPort_P15_0);
 waitTime(1*(TimeConst[(2)]));

 HLD_Lcd_setPinLow(&IfxPort_P15_0);
 waitTime(50*(TimeConst[(2)]));
}
...
static void HLD_Lcd_setData (boolean isUpper, uint8 data4bit)
{
 ...
 {
 case 1:
  HLD_Lcd_setPin(&IfxPort_P15_1, (boolean)((data4bit>>0)&0b1));
  HLD_Lcd_setPin(&IfxPort_P33_9, (boolean)((data4bit>>1)&0b1));
  HLD_Lcd_setPin(&IfxPort_P33_8, (boolean)((data4bit>>2)&0b1));
  HLD_Lcd_setPin(&IfxPort_P20_0, (boolean)((data4bit>>3)&0b1));
  break;
 default: break;
 }
}

static inline __attribute__ ((always_inline)) void HLD_Lcd_setPin(IfxPort_Pin* pin, boolean data)
{
 switch(data)
 {
 case 1: HLD_Lcd_setPinHigh(pin); break;
 case 0: HLD_Lcd_setPinLow(pin); break;
 }
}

static inline __attribute__ ((always_inline)) void HLD_Lcd_setPinHigh(IfxPort_Pin* pin)
{

 IfxPort_setPinState(pin->port,pin->pinIndex,IfxPort_State_high);
}

static inline __attribute__ ((always_inline)) void HLD_Lcd_setPinLow(IfxPort_Pin* pin)
{

 IfxPort_setPinState(pin->port,pin->pinIndex,IfxPort_State_low);
}

static inline __attribute__ ((always_inline)) void HLD_Lcd_setRs(boolean val)
{
 if(val)
  HLD_Lcd_setPinHigh(&IfxPort_P33_4);
 else
  HLD_Lcd_setPinLow(&IfxPort_P33_4);
}

static inline __attribute__ ((always_inline)) void HLD_Lcd_setRw(boolean val)
{
 if(val)
  HLD_Lcd_setPinHigh(&IfxPort_P33_12);
 else
  HLD_Lcd_setPinLow(&IfxPort_P33_12);
}
