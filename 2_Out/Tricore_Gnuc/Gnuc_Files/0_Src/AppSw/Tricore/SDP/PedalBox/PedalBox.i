# 1 "0_Src/AppSw/Tricore/SDP/PedalBox/PedalBox.c"
# 1 "C:\\Google drive\\RH_Workspace\\__RH26_Control_Base_TC275//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "0_Src/AppSw/Tricore/SDP/PedalBox/PedalBox.c"
# 12 "0_Src/AppSw/Tricore/SDP/PedalBox/PedalBox.c"
# 1 "0_Src/AppSw/Tricore/SDP/SDP.h" 1
# 31 "0_Src/AppSw/Tricore/SDP/SDP.h"
# 1 "0_Src/AppSw/Tricore/SDP/PedalBox/PedalBox.h" 1
# 14 "0_Src/AppSw/Tricore/SDP/PedalBox/PedalBox.h"
...
# 15 "0_Src/AppSw/Tricore/SDP/PedalBox/PedalBox.h" 2
# 1 "0_Src/AppSw/Tricore/SDP/SDP.h" 1
# 16 "0_Src/AppSw/Tricore/SDP/PedalBox/PedalBox.h" 2
# 46 "0_Src/AppSw/Tricore/SDP/PedalBox/PedalBox.h"
typedef struct
{
 float32 start;
 float32 end;
...
extern SDP_PedalBox_t SDP_PedalBox;
extern SDP_PedalBox_pps_t SDP_PedalBox_pps;





extern void SDP_PedalBox_run_1ms(void);
extern void SDP_PedalBox_init(void);
# 32 "0_Src/AppSw/Tricore/SDP/SDP.h" 2
# 1 "0_Src/AppSw/Tricore/SDP/SteeringAngle/SteeringAngle.h" 1
# 30 "0_Src/AppSw/Tricore/SDP/SteeringAngle/SteeringAngle.h"
typedef enum
{
 SteerNeutral,
 SteerLeft,
...
# 83 "0_Src/AppSw/Tricore/SDP/SteeringAngle/SteeringAngle.h"
extern void SDP_SteeringAngle_init(void);
extern void SDP_SteeringAngle_run_1ms(void);
# 33 "0_Src/AppSw/Tricore/SDP/SDP.h" 2
# 1 "0_Src/AppSw/Tricore/SDP/WheelSpeed/WheelSpeed.h" 1
# 43 "0_Src/AppSw/Tricore/SDP/WheelSpeed/WheelSpeed.h"
extern void SDP_WheelSpeed_init(void);
extern void SDP_WheelSpeed_run_1ms(void);
# 34 "0_Src/AppSw/Tricore/SDP/SDP.h" 2
# 13 "0_Src/AppSw/Tricore/SDP/PedalBox/PedalBox.c" 2
# 1 "0_Src/AppSw/Tricore/SDP/PedalBox/PedalBox.h" 1
# 14 "0_Src/AppSw/Tricore/SDP/PedalBox/PedalBox.c" 2
...
# 16 "0_Src/AppSw/Tricore/SDP/PedalBox/PedalBox.c" 2
# 62 "0_Src/AppSw/Tricore/SDP/PedalBox/PedalBox.c"
typedef struct
{
 float32 start;
 float32 end;
...
float32 SDP_PedalBox_errorLimit = 10;
...
static float32 SDP_PedalBox_getPedalLinear(SDP_PedalBox_sensor_t *sensor, HLD_GtmTim_dataPulse_t *tim);
static void SDP_PedalBox_initSensorConfig(SDP_PedalBox_sensorConfig_config* config);
static void SDP_PedalBox_initSensor(SDP_PedalBox_sensor_t* sensor, SDP_PedalBox_sensorConfig_config* config);
# 93 "0_Src/AppSw/Tricore/SDP/PedalBox/PedalBox.c"
...
static void SDP_PedalBox_updatePPS(SDP_PedalBox_sensor_t *data_out, HLD_GtmTim_dataPulse_t *data_in)
{
...
static void SDP_PedalBox_checkErrorState_fromTwo(SDP_PedalBox_sensor_t *data1, SDP_PedalBox_sensor_t *data2)
{
 float32 diff = (data1->pedalPercent) - (data2->pedalPercent);
 float32 absDiff = fabs(diff);

 if (absDiff>SDP_PedalBox_errorLimit)
 {
  data1 -> isValueOk = 0;
  data2 -> isValueOk = 0;
 }
...
static void SDP_PedalBox_checkErrorState_fromThree(SDP_PedalBox_sensor_t *data1, SDP_PedalBox_sensor_t *data2, SDP_PedalBox_sensor_t *data3)
{
 ...
 if((absDiff12 < SDP_PedalBox_errorLimit ) && (absDiff23 < SDP_PedalBox_errorLimit) && (absDiff31 < SDP_PedalBox_errorLimit))
 {
  data1 -> isValueOk = 1;
  data2 -> isValueOk = 1;
  data3 -> isValueOk = 1;
 ...
 else if((absDiff12 < SDP_PedalBox_errorLimit ) && (absDiff23 < SDP_PedalBox_errorLimit) && (absDiff31 >= SDP_PedalBox_errorLimit))
 {
  data1 -> isValueOk = 1;
  data2 -> isValueOk = 1;
  data3 -> isValueOk = 1;
...
static void SDP_PedalBox_updateBPPS(void)
{
 uint8 okCount = 0;
 float32 sum = 0;

 SDP_PedalBox_updatePPS(&SDP_PedalBox_pps.bpps0, &HLD_GtmTim.ch[3].data);
 SDP_PedalBox_updatePPS(&SDP_PedalBox_pps.bpps1, &HLD_GtmTim.ch[4].data);
 ...
 if(okCount>=2)
 {
  ...
  SDP_PedalBox.bpps.isValueOk = 1;
 }
 else
 {
  SDP_PedalBox.bpps.pps = 0;
  SDP_PedalBox.bpps.isValueOk = 0;
 }
}


static void SDP_PedalBox_updateAPPS(void)
{
 uint8 okCount = 0;
 float32 sum = 0;

 SDP_PedalBox_updatePPS(&SDP_PedalBox_pps.apps0, &HLD_GtmTim.ch[0].data);
 SDP_PedalBox_updatePPS(&SDP_PedalBox_pps.apps1, &HLD_GtmTim.ch[1].data);
 SDP_PedalBox_updatePPS(&SDP_PedalBox_pps.apps2, &HLD_GtmTim.ch[2].data);
 ...
 if(okCount>=2)
 {
  ...
  SDP_PedalBox.apps.isValueOk = 1;
 }
 else
 {
  SDP_PedalBox.apps.pps = 0;
  SDP_PedalBox.apps.isValueOk = 0;
 }
}
