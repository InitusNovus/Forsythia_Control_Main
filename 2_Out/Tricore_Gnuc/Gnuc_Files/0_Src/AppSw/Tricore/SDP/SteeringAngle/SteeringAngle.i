# 1 "0_Src/AppSw/Tricore/SDP/SteeringAngle/SteeringAngle.c"
# 1 "C:\\Google drive\\RH_Workspace\\__RH26_Control_Base_TC275//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "0_Src/AppSw/Tricore/SDP/SteeringAngle/SteeringAngle.c"
# 12 "0_Src/AppSw/Tricore/SDP/SteeringAngle/SteeringAngle.c"
# 1 "0_Src/AppSw/Tricore/SDP/SteeringAngle/SteeringAngle.h" 1
# 14 "0_Src/AppSw/Tricore/SDP/SteeringAngle/SteeringAngle.h"
...
# 15 "0_Src/AppSw/Tricore/SDP/SteeringAngle/SteeringAngle.h" 2
...
# 13 "0_Src/AppSw/Tricore/SDP/SteeringAngle/SteeringAngle.c" 2
# 31 "0_Src/AppSw/Tricore/SDP/SteeringAngle/SteeringAngle.c"
typedef struct
{
...
# 51 "0_Src/AppSw/Tricore/SDP/SteeringAngle/SteeringAngle.c"
...
static void SDP_SteeringAngle_initSensor(SDP_SteeringAngle_sensor_t* sensor, SDP_SteeringAngle_sensorConfig_config* config);
static void SDP_SteeringAngle_initSensorConfig(SDP_SteeringAngle_sensorConfig_config* config);
static float32 SDP_SteeringAngle_getAngleLinear(SDP_SteeringAngle_sensor_t* sensor, HLD_GtmTim_dataPulse_t *tim);
static void SDP_SteeringAngle_update(void);
# 73 "0_Src/AppSw/Tricore/SDP/SteeringAngle/SteeringAngle.c"
void SDP_SteeringAngle_init(void)
{
 SDP_SteeringAngle_sensorConfig_config config;
 SDP_SteeringAngle_initSensorConfig(&config);
 config.percentCenter = 10.0;
 config.degRange = (2*135);
 config.percentDeadzone = 0.5;
 config.reversed = 1;
...
static void SDP_SteeringAngle_update(void)
{
 SDP_SteeringAngle_getAngleLinear(&SDP_SteeringAngle.stas0, &HLD_GtmTim.ch[5].data);
