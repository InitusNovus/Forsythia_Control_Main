# 1 "0_Src/AppSw/Tricore/SDP/WheelSpeed/WheelSpeed.c"
# 1 "C:\\Google drive\\RH_Workspace\\__RH26_Control_Base_TC275//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "0_Src/AppSw/Tricore/SDP/WheelSpeed/WheelSpeed.c"
# 12 "0_Src/AppSw/Tricore/SDP/WheelSpeed/WheelSpeed.c"
...
# 13 "0_Src/AppSw/Tricore/SDP/WheelSpeed/WheelSpeed.c" 2
# 1 "0_Src/AppSw/Tricore/SDP/WheelSpeed/WheelSpeed.h" 1
# 14 "0_Src/AppSw/Tricore/SDP/WheelSpeed/WheelSpeed.c" 2
# 37 "0_Src/AppSw/Tricore/SDP/WheelSpeed/WheelSpeed.c"
typedef struct
{
 float32 gearRatio;
...
static void SDP_WheelSpeed_initSensorConfig(SDP_WheelSpeed_sensorConfig_config* config);
static void SDP_WheelSpeed_initSensor(SDP_WheelSpeed_sensor_t* sensor, SDP_WheelSpeed_sensorConfig_config* config);
static void SDP_WheelSpeed_update(void);
static void SDP_WheelSpeed_getSensorValue(SDP_WheelSpeed_sensor_t* sensor, HLD_GtmTim_dataPulse_t* tim);
# 100 "0_Src/AppSw/Tricore/SDP/WheelSpeed/WheelSpeed.c"
void SDP_WheelSpeed_init(void)
{
 ...
 config.sensorResolution = 20;
 config.wheelDiameter = 0.52324;
...
static void SDP_WheelSpeed_initSensor(SDP_WheelSpeed_sensor_t* sensor, SDP_WheelSpeed_sensorConfig_config* config)
{
 ...
 float32 freqToSpeed = 2*(3.1415926535897932384626433832795f)/resolution;
...
static void SDP_WheelSpeed_update(void)
{
 SDP_WheelSpeed_getSensorValue(&SDP_WheelSpeed.wssFL, &HLD_GtmTim.ch[6].data);
 SDP_WheelSpeed_getSensorValue(&SDP_WheelSpeed.wssFR, &HLD_GtmTim.ch[7].data);
 SDP_WheelSpeed_getSensorValue(&SDP_WheelSpeed.wssRL, &HLD_GtmTim.ch[8].data);
 SDP_WheelSpeed_getSensorValue(&SDP_WheelSpeed.wssRR, &HLD_GtmTim.ch[9].data);
 SDP_WheelSpeed.velocity.frontAxle = ((SDP_WheelSpeed.wssFL.wheelLinearVelocity + SDP_WheelSpeed.wssFR.wheelLinearVelocity)/2);
 SDP_WheelSpeed.velocity.rearAxle = ((SDP_WheelSpeed.wssRL.wheelLinearVelocity + SDP_WheelSpeed.wssRR.wheelLinearVelocity)/2);
 SDP_WheelSpeed.velocity.chassis = ((SDP_WheelSpeed.velocity.frontAxle + SDP_WheelSpeed.velocity.rearAxle)/2);
}
